...
package cn.recallcode.iot.mqtt.server.store.subscribe;
...
public class SubscribeStoreService implements ISubscribeStoreService {
    ...
    @Override
    public int getNotWildcardCacheTopicCount() {
        return subscribeNotWildcardCache.size();
    }

    @Override
    public int getWildcardCacheTopicCount() {
        return subscribeWildcardCache.size();
    }
